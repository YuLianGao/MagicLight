...
public class BluetoothLeService extends Service {
    ...
    public void sendDataCharacteristic(BluetoothGattCharacteristic characteristic, byte[] value) {
        ...
        if(UUID.fromString(BluetoothGattAttributes.LED_CHARACTERISTIC).equals(characteristic.getUuid()) || UUID.fromString(BluetoothGattAttributes.LED_WRITE_CHARACTERISTIC).equals(characteristic.getUuid())) {
            mBluetoothGattCharacteristic.setValue(value);
            mBluetoothGatt.writeCharacteristic(mBluetoothGattCharacteristic);
        }
    }

    public byte[] getDataCharacteristic(BluetoothGattCharacteristic characteristic) {
        byte[] value;
        final BluetoothGattCharacteristic mBluetoothGattCharacteristic = characteristic;
        if(UUID.fromString(BluetoothGattAttributes.LED_READ_CHARACTERISTIC).equals(characteristic.getUuid())) {
            mBluetoothGatt.readCharacteristic(mBluetoothGattCharacteristic);
            value =  mBluetoothGattCharacteristic.getValue();
            return value;
        }
        return null;
    }
