...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(R.id.colorPickerView) ColorPickerView colorPickerView;
    @BindView(R.id.seekBar) DiscreteSeekBar discreteSeekBar;
    @BindView(R.id.seekBar_sensitive) DiscreteSeekBar sensitivebar;
    @BindView(R.id.ripple) RippleBackground rippleBackground;
